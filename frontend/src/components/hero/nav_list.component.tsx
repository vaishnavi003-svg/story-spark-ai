  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-white/90 dark:bg-[#0B1120]/80 backdrop-blur-md border-b border-slate-200/70 dark:border-white/10 transition-colors duration-300">
      <div className="relative z-10 mx-auto max-w-8xl px-5 py-4">
        <div className="flex items-center justify-between w-full">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="lg:hidden text-slate-600 dark:text-slate-400 hover:text-slate-900 dark:hover:text-slate-300 p-2 transition-all duration-300"
        ...
        {menuOpen && (
          <div className="lg:hidden px-5 pb-4 flex flex-col gap-3 border-t border-slate-200/70 dark:border-white/10 mt-2">
